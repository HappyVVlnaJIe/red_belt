...
template<typename TAirport>
array<pair<TAirport, size_t>, static_cast<uint32_t>(TAirport::Last_)> AirportCounter<TAirport>::GetItems() const
{
    array<pair<TAirport, size_t>, static_cast<uint32_t>(TAirport::Last_)> result;
...
template<typename TAirport>
template<typename TIterator>
AirportCounter<TAirport>::AirportCounter(TIterator begin, TIterator end):AirportCounter()
{
    auto it = begin;
    while (it != end) {
